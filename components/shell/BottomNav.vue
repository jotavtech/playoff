...
const tabs = [
  ...
  },
  {
    to: '/karaoke',
    label: 'Karaokê',
    path: 'M12 15c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v7c0 1.66 1.34 3 3 3zm5.91-3c-.49 3.05-3.05 5.4-6.13 5.4S5.58 15.05 5.09 12H3.1C3.63 15.64 6.52 18.5 10 19.09V22h4v-2.91c3.48-.59 6.37-3.45 6.9-7.09h-1.99z',
  },
  {
    to: '/queue',
    label: 'Fila',
